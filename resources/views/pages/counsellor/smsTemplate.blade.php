...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><span><img src="{{url('postlogin/images/counselling.png')}}"  style="margin-right: 10px;width: 30px;" alt="counselling"></span>SMS Template</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <form class="study_lesson">
                ...
                <table id="smstemplate" class="table table-bordered table-hover">
                  <thead>
                  <tr>
                    <th>S.No</th>
