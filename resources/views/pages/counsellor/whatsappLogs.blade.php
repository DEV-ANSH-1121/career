                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="study_lesson">
                                    <!-----------BY WHAT'S--------->
                                    <div class="row px-5 bywhatsapp justify-content-center">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <!-- <label>Message</label> -->
                                                <textarea id="summernotewh">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <h3 class="progressreport text-center"><i class="far fa-file"></i>WhatApp Report</h3>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="allreport.php"><button class="Verify">All Report</button></a>
                                    </div>
                                </div>
                                <table id="whatsappbyme" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
